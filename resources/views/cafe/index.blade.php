...
@section('content')
    ...
    <div id="cafeDetailModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            <!-- Header -->
            <div class="bg-[#996207] px-4 sm:px-6 py-4 sm:py-6 text-white relative flex-shrink-0">
                ...
                <div class="p-4 sm:p-6 pb-8 space-y-6">
                    ...
                    <div class="grid gap-4 sm:gap-6 lg:grid-cols-2">
                        ...
                        <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100">
                            ...
                            <div id="detailInstagramLink" class="mt-3 hidden">
                        ...
                        <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100">
                            ...
                            <div class="space-y-4 mt-6">
                                ...
                                <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                    ...
                                    <span id="detailKeteranganMotor" class="text-sm sm:text-base font-semibold text-gray-900">-</span>
                                </div>
                                <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                    <span class="text-sm sm:text-base text-gray-600 flex items-center">
                                        <svg class="w-4 h-4 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span id="detailKeteranganMobil" class="text-sm sm:text-base font-semibold text-gray-900">-</span>
                                </div>
                                <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                    <span class="text-sm sm:text-base text-gray-600 flex items-center">
                                        <svg class="w-4 h-4 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span id="detailKeteranganMushola" class="text-sm sm:text-base font-semibold text-gray-900">-</span>
                                </div>
                                <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                    <span class="text-sm sm:text-base text-gray-600 flex items-center">
                                        <svg class="w-4 h-4 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span id="detailKeteranganToilet" class="text-sm sm:text-base font-semibold text-gray-900">-</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function showCafeDetail(cafeData) {
            ...
            // Panggil fungsi updateInstagramLink
